...
def simple_demo():
    ...
    #c.goto_xyz_rpy(0,0,1.2,0,0,-1*pi_2)
    #rospy.sleep(2)
    #c.goto_xyz_rpy(0.4,0.0,1,0,0,-1*pi_2)
    #rospy.sleep(3)
    #print("Waypoint 2: position control")
    #c.goto_xyz_rpy(0.4,0.0,1,0,0,0)
    #rospy.sleep(2)
    #c.goto_xyz_rpy(0.4,0.4,1,0,0,0)
    #rospy.sleep(3)
    #print("Waypoint 3: position control")
    #c.goto_xyz_rpy(0.4,0.4,1,0,0,pi_2)
    #rospy.sleep(2)
    #c.goto_xyz_rpy(0.0,0.4,1,0,0,pi_2)
    #rospy.sleep(3)
    #print("Waypoint 4: position control")
    #c.goto_xyz_rpy(0.0,0.4,1,0,0,2*pi_2)
    #rospy.sleep(2)
    #c.goto_xyz_rpy(0.0,0.0,1,0,0,2*pi_2)
    #rospy.sleep(3)
